            ...
            <form name="form" action="registration.php" method="post">
                <div class="user_info">
                    ...
                    <div class="input">
                        ...
                        <input type="email" placeholder="Podaj swój email." id="email" name="email" required />
                    </div>
                    <div class="input">
                        <label for="phonenumber" class="text_above_fill">Numer telefonu</label>
                        <input type="text" placeholder="Podaj swój numer telefonu." id="phonenumber" name="phonenumber" required />
                    </div>
                    <div class="input">
                    ...
                    <div class="input">
                        ...
                        <input type="password" placeholder="Powtórz swoje hasło." required name="text4" id="passrep" />
                    </div>
                </div>
                <div class="submit">
                  <input type="submit" name="create" class="button" id="register" value="Zarejestruj się"/>
                </div>
                <div class="acc">Masz już konto? <a href="login.html">Zaloguj się teraz.</a></div>
            </form>
        </div>
                ...
                if (valid) {
                    ...
                    $.ajax({
                        ...
                        error: function (data) {
                            Swal.fire({
                                title: "Błąd",
                                text: "Wystąpił błąd przy zapisywaniu danych. Spróbuj ponownie później.",
                                type: "error",
                            });
                        },
                    });
